            ...
            <div class="row" v-else style="min-height:120px">
                ...
                <!-- <h6 class="py-2"> <span><i class="fas fa-utensils mr-2 text-danger"></i></span> Restaurant</h6> -->
                        <swiper-slide  class="col-6" v-for="(rent,index) in rents" :key="index">
                            ...
                            <div class="rate" v-if="rent.rate > 0.0"><span v-bind:class="rent.rate_color" class="btn mr-2"> <i class="fas fa-star text-white fa-1x mr-1"></i>{{rent.rate}}</span></div>
                            </a>
            ...
            <div class="row" v-else style="min-height:120px">
                <swiper class="swiper" :options="settings">
                        <swiper-slide  class="col-6" v-for="(service,index) in services" :key="index">
                            ...
                            <div class="rate" v-if="service.rate >0.0"><span v-bind:class="service.rate_color" class="btn mr-2"><i class="fas fa-star text-white fa-1x mr-1"></i>{{service.rate}}</span></div>
                            </a>
            ...
            <div class="row" v-else style="min-height:120px">
                <swiper class="swiper" :options="settings">
                        <swiper-slide  class="col-6" v-for="(restaurant,index) in restaurants" :key="index">
                            ...
                            <div class="rate" v-if="restaurant.rate > 0.0"><span v-bind:class="restaurant.rate_color" class="btn mr-2"> <i class="fas fa-star text-white fa-1x mr-1"></i>{{restaurant.rate}}</span></div>
                            </a>
