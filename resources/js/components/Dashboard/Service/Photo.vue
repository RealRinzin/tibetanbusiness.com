  ...
  <div id="dashboard_photo">
    ...
    <div class="row">
      <div class="col-md-2 col-sm-4 col-6" v-for="(photo,index) in photos">
        ...
        <div class="card gallery_view lazyload" @click="photo_view(index)" data-toggle="modal" data-target="#event_photo" v-bind:style='{ backgroundImage: `url(/storage/Service/Photos/${photo.thumb})`}' data-sizes="auto">
          <div class="overlay">
                    ...
                    <div id="photo" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item animated fadeIn duration-1s" v-for="(photo,index) in photos" :class="{ active: index==active }">
                                <div style="height:55vh" class="slide" v-bind:style='{ backgroundImage: `url(/storage/Service/Photos/${photo.path})`}'></div>
                            </div>
                        </div>
  ...
  export default {
    ...
    methods:{
      ...
      remove(id,index){
        ...
        if(confirmBox == true){
          axios.delete('/api/service_photo/'+id,{
       ...
       *  */ 
        ...
        upload(id) {
            ...
            axios.post('/api/service_photo', formData,{
              headers : { Authorization : localStorage.getItem("token")}
            })
              .then(response => {
                //  Flash Message  
