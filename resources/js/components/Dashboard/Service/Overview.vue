        ...
        <div class="row">
            <div class="col-md-12 card py-3">
                ...
                <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row py-1">
                                ...
                                <div class="row py-1">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <h6 class="text-muted">{{service.email}} People</h6>
                                    </div>
                                </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                                <div class="row py-1" v-if="service.facebook">
                                    <div class="col-md-4 col-sm-4"><h6 class="text-dark">facebook:</h6>
                                    </div>
                                    <div class="col-md-8 col-sm-8">
                                        <a :href="service.facebook" class="text-primary">
                                            <h6 class="text-muted">{{service.facebook}}</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="row py-1" v-if="service.instagram">
                                    <div class="col-md-4 col-sm-4">
                                        <h6 class="text-dark">Instagram:</h6>
                                    </div>
                                    <div class="col-md-8 col-sm-8">
                                        <h6 class="text-muted">{{service.instagram}}</h6>
                                    </div>
                                </div>
                                <div class="row py-1" v-if="service.website">
                                    <div class="col-md-4 col-sm-4">
...
<!-- Modal -->
        <div class="modal fade" id="event_overview_update_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-header bg-secondary text-white">
                    ...
                    <form @submit.prevent="update_overview(service.id)"  data-vv-scope="event_validate_update_form">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div v-if="errors.has('event_validate_update_form.name')" class="invalid-feedback">
                                                <span v-for="error in errors.collect('event_validate_update_form.name')">{{ error }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-validate="'required|min:2|max:40'" v-model="service.category" name="category" class="form-control" id="category" aria-describedby="emailHelp" placeholder="Select Category">
                                            <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-validate="'numeric|max:6'" v-model="service.entry_fee" name="entry_fee" class="form-control" id="entry_fee" aria-describedby="emailHelp" placeholder="Entry Fee">
                                            <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-validate="'required'" v-model="service.location" name="location" class="form-control" id="location" aria-describedby="emailHelp" placeholder="Location">
                                            <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-validate="'required|max:10|digits:10'" v-model="service.mobile_no" name="mobile_no" class="form-control" id="mobile_no" aria-describedby="emailHelp" placeholder="Mobile No">
                                            <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-validate="'required|max:45|email'" v-model="service.email" name="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Email">
                                            <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" v-validate="'required'" v-model="service.start_date" name="start_date" class="form-control" id="start_date" aria-describedby="emailHelp" placeholder="Starting Date">
                                            <div class="valid-feedback"></div>
                                            <div v-if="errors.has('event_validate_update_form.start_date')" class="invalid-feedback">
                                                <span v-for="error in errors.collect('event_validate_update_form.start_date')">{{ error }}</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time"  v-model="service.start_time" name="start_time" class="form-control" id="start_time" aria-describedby="emailHelp" placeholder="Starting Date">
                                                    <div class="valid-feedback"></div>
                                                    <div v-if="errors.has('event_validate_update_form.start_time')" class="invalid-feedback">
                                                        <span v-for="error in errors.collect('event_validate_update_form.start_time')">{{ error }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time"  v-model="service.end_time" name="end_time" class="form-control" id="end_time" aria-describedby="emailHelp" placeholder="Ending Time">
                                                    <div class="valid-feedback"></div>
                                                    <div v-if="errors.has('event_validate_update_form.end_time')" class="invalid-feedback">
                                                        <span v-for="error in errors.collect('event_validate_update_form.end_time')">{{ error }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" v-validate="''" v-model="service.end_date" name="end_date" class="form-control" id="end_date" aria-describedby="emailHelp" placeholder="Starting Date">
                                            <div class="valid-feedback"></div>
                                            <div v-if="errors.has('event_validate_update_form.end_date')" class="invalid-feedback">
                                                <span v-for="error in errors.collect('event_validate_update_form.end_date')">{{ error }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" cols="50" v-validate="'required|max:150'" v-model="service.address" name="address" class="form-control" id="address" aria-describedby="emailHelp" placeholder="Address" ></textarea>
                                            <div class="valid-feedback"></div>
...
export default {
    ...
    methods:{
        // modal
        edit(){
            $("#event_overview_update_modal").modal("show");           
        },
        // Update
        update_overview(id){
                this.$validator.validateAll('event_validate_update_form').then((result) => {
                    if (result) {
                        axios.patch('/api/service/'+id,this.service,{
                            headers : { Authorization : localStorage.getItem("token")}
                        })
                        .then(response=>{
                            this.$Progress.start();
                            // Close Modal
                            $("#event_overview_update_modal").modal("hide");  
                            //  Flash Message  
                            toast.fire({
                                icon:'success',
                                title:'Updated',
