  ...
  <div id="dashboard_photo">
    ...
    <div class="row">
      <div class="col-md-2 col-sm-4 col-6" v-for="(photo,index) in photos">
        ...
        <div class="card gallery_view lazyload" @click="photo_view(index)" data-toggle="modal" data-target="#rent-room-photo" v-bind:style='{ backgroundImage: `url(/storage/Rent/Room-Photos/${photo.thumb})`}' data-sizes="auto">
              <div class="overlay">
...
<!-- Carousel and Modal -->
    <!-- More Photo Modal -->
    <div class="modal fade" id="rent-room-photo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body" v-if="modal_status">
                    <div id="RentRoomPhoto" class="carousel slide" data-ride="carousel">
                        ...
                        <a class="carousel-control-prev" href="#RentRoomPhoto" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="carousel-control-next" href="#RentRoomPhoto" role="button" data-slide="next">
...
<!-- Photo upload modal -->
    <div class="modal fade" id="upload_rent_room_photos_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
...
<script>
  export default {
    ...
    methods:{
      ...
      // Menu modal
      RoomPhotoModal(){
            $("#upload_rent_room_photos_modal").modal("show");           
      },
      /**
       * Image Upload 
       * Methods
