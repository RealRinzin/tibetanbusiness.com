  ...
  <div>
    ...
    <div class="row">
      <div class="col-md-2 col-sm-4 col-xs-6" v-for="(photo,index) in photos">
        <div class="card gallery_view" @click="photo_view(index)" data-toggle="modal" data-target="#rent-view-photo"  v-bind:style='{ backgroundImage: `url(/storage/Rent/View-Photos/${photo.path})`}'>
              <div class="overlay">
...
<script>
  export default {
    props:['view_photos','id','rent_load'],
    data() {
      return {
