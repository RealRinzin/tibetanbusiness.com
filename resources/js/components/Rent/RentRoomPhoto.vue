<template>
    <div>
        <div class="row p-3">
            ...
            <div class="col-md-3 col-sm-4 col-6 py-2" v-for="(room_photo,index) in room_photos" v-if="index < 7">
                <div class="photo lazyload" @click="room_photo_modal(index)" :data-bgset="'/storage/Rent/Room-Photos/'+room_photo.thumb"  data-sizes="auto"></div>
            </div>
            <!-- More Photos -->
